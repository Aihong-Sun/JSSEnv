...
class TestSolution(unittest.TestCase):
    ...
    def test_optimum_ta01(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta01'})
        env.reset()
    ...
    def test_optimum_ta41(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta41'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta42(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta42'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta43(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta43'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta44(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta44'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta45(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta45'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta46(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta46'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta47(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta47'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta48(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta48'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta49(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta49'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
    ...
    def test_optimum_ta50(self):
        ...
        env = gym.make('JSSEnv:jss-v1', env_config={'instance_path': '../../JSSEnv/envs/instances/non_flexible/ta50'})
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
        solution_sequence = [
